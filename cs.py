    ...
    for line in output.split("\n"):
        ...
        for i in down_data:
            if not (line.startswith(line)):
               # pywhatkit.sendwhatmsg_to_group_instantly(f"Lmj4HDmcvkk91oAXSKMoXx","{line}Host is down")
                down.write(i)             
        down.truncate()
...
def remove_if_not_down(output=None):
    ...
    for line in output.split("\n"):
        ...
        for i in up_data:
            if not (line.startswith(line)):
               # pywhatkit.sendwhatmsg_to_group_instantly(f"Lmj4HDmcvkk91oAXSKMoXx","{line}Host is up now")
                up.write(i)        
        up.truncate()
